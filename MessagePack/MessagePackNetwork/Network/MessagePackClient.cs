...
namespace MessagePack
{
    public class MessagePackClient
    {
        ...
        private MessagePackClientInternal client;
        private GenericMessageSerializer<MessageEnvelope, MessagePackSerializer_> serialiser = new GenericMessageSerializer<MessageEnvelope, MessagePackSerializer_>();

        public MessagePackClient()
        {
            client = new MessagePackClientInternal();
