...
//{
//    public class GenericMessageSerializer<z,S> : IMessageSerialiser<z>
//        where S : ISerializer, new()
//        where z : IMessageEnvelope, new()
//    {
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public E DeserialiseEnvelopedMessage<E>(byte[] buffer, int offset, int count)
// where E : IMessageEnvelope
//        {
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public void EnvelopeMessageWithInnerMessage<E,T>(Stream serialisationStream, E empyEnvelope, T payload)
// where E : IMessageEnvelope
//        {
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public void EnvelopeMessageWithBytes<E>(Stream serialisationStream, E empyEnvelope, byte[] payloadBuffer, int offset, int count)
//             where E : IMessageEnvelope
//        {
//            serialisationStream.Position = 2;
//            Serializer.Serialize(serialisationStream, empyEnvelope);
...
namespace MessageProtocol
{
        ...
        where E : IMessageEnvelope, new()
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void EnvelopeMessageWithInnerMessage<T>(Stream serialisationStream, E empyEnvelope, T payload)
        {
            serialisationStream.Position = 2;
            Serializer.Serialize(serialisationStream, empyEnvelope);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void EnvelopeMessageWithBytes(Stream serialisationStream, E empyEnvelope, byte[] payloadBuffer, int offset, int count)
        {
            serialisationStream.Position = 2;
            Serializer.Serialize(serialisationStream, empyEnvelope);
