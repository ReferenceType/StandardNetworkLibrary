...
//using Protobuff.Components.TransportWrapper.Generic.Components;
...
//        internal MessageServer(int port) : base(port)
//        {
...
//        public Task<E> SendMessageAndWaitResponse<T>(Guid clientId, E message, T payload, int timeoutMs = 10000) where T : IProtoMessage
//        {
//            if (message.MessageId == Guid.Empty)
//                message.MessageId = Guid.NewGuid();
