...
namespace BinaryMessageBenchmark
{
    internal class Program
    {
        ...
        private static List<BinaryMessageClient> clients = new List<BinaryMessageClient>();
        private static BinaryMessageServer server;
        ...
        private static void InitializeServer()
        {
            ...
            server = new BinaryMessageServer(port);
        ...
        private static void InitializeClients()
        {
            ...
            clients = new List<BinaryMessageClient>();

            for (int i = 0; i < numClients; i++)
            {
                var client = new BinaryMessageClient();
