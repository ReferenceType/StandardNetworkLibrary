...
namespace CustomSerializerBenchmark
{
    internal class Program
    {
        ...
        private static List<CustomMessageClient> clients = new List<CustomMessageClient>();
        private static CustomMessageServer server;
        ...
        private static void InitializeServer()
        {
            ...
            server = new CustomMessageServer(port);
        ...
        private static void InitializeClients()
        {
            ...
            clients = new List<CustomMessageClient>();

            for (int i = 0; i < numClients; i++)
            {
                var client = new CustomMessageClient();
        ...
        {
            NetworkLibrary.Utils.MiniLogger.AllLog += (string log) => Console.WriteLine(log);
