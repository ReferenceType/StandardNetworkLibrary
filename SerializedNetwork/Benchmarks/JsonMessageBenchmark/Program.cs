...
namespace JsonMessageBenchmark
{
    internal class Program
    {
        ...
        private static List<JsonMessageClient> clients = new List<JsonMessageClient>();
        private static JsonMessageServer server;
        ...
        private static void InitializeServer()
        {
            ...
            server = new JsonMessageServer(port);
        ...
        private static void InitializeClients()
        {
            ...
            clients = new List<JsonMessageClient>();

            for (int i = 0; i < numClients; i++)
            {
                var client = new JsonMessageClient();
