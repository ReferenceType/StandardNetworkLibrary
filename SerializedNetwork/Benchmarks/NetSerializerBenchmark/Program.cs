...
namespace NetSerializerBenchmark
{
    internal class Program
    {
        ...
        private static List<NetSerializerClient> clients = new List<NetSerializerClient>();
        private static NetSerializerServer server;
        ...
        private static void InitializeServer()
        {
            ...
            server = new NetSerializerServer(port);
        ...
        private static void InitializeClients()
        {
            ...
            clients = new List<NetSerializerClient>();

            for (int i = 0; i < numClients; i++)
            {
                var client = new NetSerializerClient();
