...
namespace JsonMessageNetwork
{
    public class JsonMessageServer
    {
        ...
        internal readonly JsonMessageServerInternal server;
        private GenericMessageSerializer<MessageEnvelope, JsonSerializer> serialiser
        ...
        public JsonMessageServer(int port)
        {
            ...
            server = new JsonMessageServerInternal(port);
