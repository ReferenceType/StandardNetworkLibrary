...
{
    public class MessagePackMessageClient
    {
        public Action<MessageEnvelope> OnMessageReceived;
        public Action OnDisconnected;

        private MessagePackMessageClientInternal client;
        private GenericMessageSerializer<MessageEnvelope, MessagepackSerializer> serialiser = new GenericMessageSerializer<MessageEnvelope, MessagepackSerializer>();

        public MessagePackMessageClient()
        {
            client = new MessagePackMessageClientInternal();
