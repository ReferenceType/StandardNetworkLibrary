...
{
    public class MessagePackMessageServer
    {
        ...
        internal readonly MessagePackMesssageServerInternal server;
        private GenericMessageSerializer<MessageEnvelope, MessagepackSerializer> serialiser
            = new GenericMessageSerializer<MessageEnvelope, MessagepackSerializer>();


        public MessagePackMessageServer(int port)
        {
            //awaiter = new MessageAwaiter();

            server = new MessagePackMesssageServerInternal(port);
